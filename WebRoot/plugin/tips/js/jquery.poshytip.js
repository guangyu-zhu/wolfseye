...
(function($) {
	...
	$.fn.poshytip.defaults = {
		...
		showTimeout:		0,		// timeout before showing the tip (in milliseconds 1000 == 1 second)
...
function renderTips(clazz){
	jQuery(clazz).poshytip({
		showTimeout: 0
	});
}

function renderTips(clazz,title){
	jQuery(clazz).attr('title',title).poshytip({
		showTimeout: 1
	});
}
